package entechlib.util;

public final class EntechUtils {

    /**
     * return value that is in the range between limit1 and limit2 capping the value
     * if original value is outside the range
     ...
     * @return value value is greater minMagnitude. Sign is preserved from the input
     *         value.
     */
